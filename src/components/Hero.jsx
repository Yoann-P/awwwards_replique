...
const Heros = () => {
  ...
  useGSAP(() => {
    gsap.set("#video-frame", {
      clipPath: "polygon(10% 0%, 77% 0%, 92% 85%, 0% 100%)",
      ...
      >
       ...
       size-64 cursor-pointer overflow-hidden rounded-lg "
          >
            ...
            opacity-0 transition-all duration-500 hover:scale-100 hover:opacity-100"
            >
              <video
                ref={nextVideoRef}
        ...
        absolute bottom-5 z-40 right-5 text-blue-75"
        >
          G<b>a</b>ming
        </h1>
