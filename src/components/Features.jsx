  ...
  return (
    <section className="bg-black pb-52">
      <div className="container mx-auto px-3 md:px-10">
        ...
        <div
          className="border-hsla relative mb-7 
      h-96 w-full overflow-hidden 
      rounded-md md:h-[65]vh"
        >
          <BentoCard
            ...
            description="A cross-platform metagame app, turning our activities across
        Web2 & Web3 games into a rewarding adventure"
          />
        </div>
        ...
        <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
          <div className="bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2">
            <BentoCard
              ...
              description="An anime abd gaming-inspired NFT collection - the IP rimed for expansion"
            />
          </div>
